    ...
    private void initView(){
        ...
        etSearch.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int screenHeight = etSearch.getRootView().getHeight();
        ...
        recyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                String url = StockImgApi.IMG_F+idtext.split("_")[1]+".gif";
                Intent intent = new Intent(SerachActivity.this,StockImgActivity.class);
        ...
        searchListAdapter.setOnItemClickLitener(new SearchListAdapter.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                String idtext = stockBeanList.get(position-1).getNumber();
                String url = StockImgApi.IMG_F+idtext.split("_")[1]+".gif";
                Intent intent = new Intent(SerachActivity.this,StockImgActivity.class);
                intent.putExtra("url",url);
                intent.putExtra("id",idtext);
