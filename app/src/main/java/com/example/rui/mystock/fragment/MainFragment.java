...
public class MainFragment extends Fragment implements View.OnClickListener{
    ...
    private final static String Zz500Index = "s_sh000905";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(final String response) {
                        ThreadPoolManager.getSinglePool().execute(new Runnable() {
                            @Override
                            public void run() {
                                MyDbManager.getInstance(getActivity()).replace(responseToStocks(response));
...
//                        handler.removeCallbacksAndMessages(null);
    ...
    public List<StockBean> responseToStocks(String response){
        ...
        for(String stock : stocks) {
            ...
            StockBean  stockBean= MyDbManager.getInstance(getActivity()).getStockByNumberOrName(number);
            if(stockBean!=null){
...
//                        Toast.makeText(MainActivity.this,"数据请求失败",Toast.LENGTH_LONG).show();
    ...
    private void refreshHeaderStock(){
        String idsStr = ShIndex + "," + SzIndex + "," + ChuangIndex+","+Sh50Index+","+Sh300Index+","+Zz500Index
    ...
    private void updateStockHeader(List<Stock> stocks) {
        for (Stock stock : stocks) {
            ...
            if (stock.id_.equals(ShIndex) || stock.id_.equals(SzIndex) || stock.id_.equals(ChuangIndex)
                    ...
                    || stock.id_.equals(Sh50Index) || stock.id_.equals(Sh300Index) || stock.id_.equals(Zz500Index)) {
                int indexId;
                int changeId;
                int nameId;
